...
return function (App $app): void {
    $app->group('/api', function (RouteCollectorProxy $api): void {
        ...
        // --- Juror ----------------------------------------------------
        $api->group('', function (RouteCollectorProxy $jury): void {
        ...
        })->add(RequireRole::juror());

        // --- Organizer: runs the contest, including all round management
        $api->group('', function (RouteCollectorProxy $org): void {
        ...
        })->add(RequireRole::organizer());

        // --- Administrator: campaigns themselves, and the admin dashboard
        $api->group('', function (RouteCollectorProxy $admin): void {
            $admin->post('/campaigns', [CampaignActions::class, 'create']);
